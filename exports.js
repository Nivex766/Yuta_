...
const vdddsf = JSON.parse(fs.readFileSync("./DADOS DO YUTA/vdddsf.json"));
const obrigadoEXT = JSON.parse(fs.readFileSync('./INFO_YUTA/media/nescessario.json'))
...
const countMessage = JSON.parse(fs.readFileSync('./INFO_YUTA/media/countmsg.json'));
const comandos = JSON.parse(fs.readFileSync('./INFO_YUTA/media/comandos.json'));
const daily = JSON.parse(fs.readFileSync('./DADOS DO YUTA/usuarios/diario.json'));
const nescessario = JSON.parse(fs.readFileSync('./INFO_YUTA/media/nescessario.json'));
...
const antispam = JSON.parse(fs.readFileSync('./INFO_YUTA/media/antispam.json'));
const anotar = JSON.parse(fs.readFileSync("./DADOS DO YUTA/func/anotar.json"));
const setting = JSON.parse(fs.readFileSync('./INFO_YUTA/DADOS/INFO_YUTA.json'));
const logoslink = JSON.parse(fs.readFileSync('./INFO_YUTA/LOGOS/links_img.json'));
const Limit_CMD = JSON.parse(fs.readFileSync("./DADOS DO YUTA/func/limitarcmd.json"))
const ftmenu = JSON.parse(fs.readFileSync("./INFO_YUTA/LOGOS/logos.json"));
...
const { linguagem, mess, getInfo } = require('./INFO_YUTA/lib');
